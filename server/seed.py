...
from app import db, User, AstrologicalSign, Match, BestMatch, UserMatch
...
#                 'birthday': fake.date_of_birth(minimum_age=18, maximum_age=99).strftime('%Y-%m-%d'),
#                 'astrological_sign_id': randint(1, 12)
#             }
#             users_data.append(user_data)
...
#NO FAKER BUT ALSO NO BIRTHDAY TO SIGN LOGIC
